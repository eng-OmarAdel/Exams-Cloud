var SnippetLogin = function() {
    var s = $("#m_login")
      ...
      , o = function() {
        s.removeClass("m-login--forget-password"),
        s.removeClass("m-login--signup"),
        s.addClass("m-login--signin"),
        mUtil.animateClass(s.find(".m-login__signin")[0], "flipInX animated")
    }
      , e = function() {
        $("#m_login_forget_password").click(function(e) {
            e.preventDefault(),
            s.removeClass("m-login--signin"),
            s.removeClass("m-login--signup"),
            s.addClass("m-login--forget-password"),
            mUtil.animateClass(s.find(".m-login__forget-password")[0], "flipInX animated")
        }),
        ...
        $("#m_login_signup").click(function(e) {
            ...
            mUtil.animateClass(s.find(".m-login__signup")[0], "flipInX animated");
                Form_submit.init();
                ...
                r.ajaxSubmit({
                    ...
                    success: function(e, i, a, l) {
                        setTimeout(function() {
                            ...
                            n(e, "success", "Cool! Password recovery instruction has been sent to your email.")
                        }, 2e3)
                    }
                }))
            })
