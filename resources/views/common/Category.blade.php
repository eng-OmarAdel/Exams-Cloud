										...
										<li class="m-portlet__nav-item">
											<div class="dropdown">
												<button onclick="actions()" id="modal_button" data-toggle="modal" data-target="#m_modal_4" href="#" class="btn btn-success" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
														New child category <i class="la la-plus"></i>
												</button>
										</div>

										</li>

										<li class="m-portlet__nav-item">		<a class="btn btn-brand" href="{{url('/?view=Question&cat_id='.$_GET['id'].'&cat_type=1')}}">Questions<i class="la la-question"></i></a></li>
										<li class="m-portlet__nav-item">				<a class="btn btn-brand" href="{{url('/?view=Exams&cat_id='.$_GET['id'].'&cat_type=1')}}">Exams <i class="la la-list-ol"></i></a></li>
