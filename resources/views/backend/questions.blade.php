                ...
                <div class="m-portlet__body">
                    ...
                    <div id="test">
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <input type="text" class="ignoreField form-control m-input" name="title"  id="title"  placeholder="Question">
                        </div>
                        <div class="form-group m-form__group">
                        ...
                        <div class="form-group m-form__group">
                            <label for="exampleInputPassword1">Difficulty</label>
                                    <select class="form-control m-input m-input--air" name="difficulty">
                        ...
                        <div id="answers1"> 
                            ...
                            <div id="answer" style="margin-top:10px;">
                                    ...
                                    <input class="form-control m-input m-input--air" type="text" required placeholder="answer"  name="answer[]">
                                    </div>
                                    <div class="col-md-2">
                                    <label for="true_answer">true</label>
                                    <input class="form-control m-input m-input--air" value="1"  type="checkbox" id="true_answer" name="true_answer[]">
                                    </div>
                                        ...
                                        <input class="form-control m-input m-input--air" required type="text"  placeholder="answer"  name="answer[]">
                                        </div>
                                        <div class="col-md-2">
                                        <label for="true_answer">true</label>
                                        <input class="form-control m-input m-input--air" value="1" type="checkbox" id="true_answer" name="true_answer[]">
...
$.each( answers, function( key, value ) {
  ...
  //   $("[name=answer]").each(function(key, value){
...
$(document).on('click', "#addanswer" , function(e) {
 ...
 $("#answer").append(`
<div class="subdays form-group m-form__group row"><div class="col-lg-12 col-md-12 col-sm-12"> <div class="input-group pull-right " > 
